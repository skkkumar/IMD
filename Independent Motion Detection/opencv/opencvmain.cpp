...
public:
    ...
    yarp::sig::Vector returnVelocity()
    {
      ogaze->getJointsVelocities ( velVect );
//       enc->getEncoder(pos, &position);
//       cout << *(velVect.data()+pos)<<endl<<flush;
      return velVect;
    }
...
// 	    cout<<strhuman_cmd<<endl<<flush;
	    ...
	    {
// 	      cout<<"Inside TrainML"<<endl<<flush;
	      ml.trainData();
	      first = 0;
            }
...
// 	    Property obGaze ( "(device gazecontrollerclient)" );
    ...
    {
      cout<<"Problem with opening"<<endl<<flush;
        return false;
    }
    // open the view
